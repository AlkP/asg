...
;(function ( $, window, document, undefined ) {
    ...
    var pluginName = 'Calendar',
        ...
        defaults = {
            weekStart: 1,
            msg_days: ["Вс", "Пн", "Вт", "Ср", "Чт", "Пт", "Сб"],
            msg_months: ["Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь"],
            msg_today: 'Сегодня',
            msg_events_header: 'Органайзер',
            events: null
        },
        ...
        for(var i=1; i<=daysInMonth[live_date.getMonth()]; i++){
            $.each(events.event, function(){
                ...
                if( event_date.getDate() == view_date.getDate()
                    ...
                    .popover({
                        'title': msg_evnts_hdr,
                        'content': 'Напоминаний на дату: ' +this.title+ ' ',
